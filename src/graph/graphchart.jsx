import FBgraphchart from "../../graph/src/graph/FBgraphchart";
import Graphfooter from "../../graph/src/graph/graphfooter";
import Gnav from "../../graph/src/graph/graphnav";
import Instagraphchart from "../../graph/src/graph/instagraphchart";
import Twittergraphchart from "../../graph/src/graph/twittergraphchart";
import Whatappgraphchart from "../../graph/src/graph/whatappgraphchart";
export default function Graphchart() {
  return (
    ...
    <div className="what-graphchart">
       ...
       <p>
      <span>WhatsApp</span> Launched in 2009, WhatsApp saw rapid adoption for free messaging. By 2015, it reached 1 billion installs, and by 2020, over 5 billion downloads on Android alone. The app continues steady growth due to reliability and end-to-end encryption, especially in India, Brazil, and Europe. </p>
      <Whatappgraphchart/>
    </div>
